...
const LOG_ON = true; // If to Show error logging
const LOG_FREQUENCY = 20000; // How often to show logs in iterations
...
class NeuralNetwork {
    constructor(numImputs, numHidden, numOutputs) {
        ...
        this._loggingCount = LOG_FREQUENCY;
    ...
    set loggingCount(loggingCount) {
        this._loggingCount = loggingCount;
    }
    ...
    train(inputArray, targetArray) {
        ...
        //Error Logging
        if (LOG_ON) {
            if (this.loggingCount == LOG_FREQUENCY) {
                // console.log("Error = " + outputErrors.data[0][0])
            }
            this.loggingCount--;
            if (this.loggingCount == 0) {
                this.loggingCount = LOG_FREQUENCY;
            }
        }
